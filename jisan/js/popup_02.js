$(document).ready(function(){
	...
	var obj_wrap=$(".popup");
	//움직일 오브젝트의 이름
	var obj_name = $(".popup ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".popup ul li");
	...
	var ctrl_next = $(".facilities .next");
	var ctrl_prev = $(".facilities .prev");
	var ctrl_stop = $(".popup .stop");
	var ctrl_play = $(".popup .play");

	//현재팝업 번호 / 전체 팝업번호
	var numbering = true;//사용여부 (true, false)
	var curr_num = $(".facilities .numbering .curr_num");
	var total_num = $(".facilities .numbering .total_num");

	//팝업 리스트
	var paging = true;//사용여부 (true, false)
	var paging_obj = $(".popup .paging button");
